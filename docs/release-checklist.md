...
- 快照：`data/snapshot/release-2026-09-02.json` 与 `data/snapshot/reviewed.json` 已从官方 ATS 图谱重导出，包含 12 个岗位、1603 项技能、3564 条未撤回证据、2998 个事件、0 个岗位定义和 0 条声明；文件 SHA-256 为 `20db7503ef3385c2ae9a5895a6f7a7acca3a0e2bd15ebb066dc5cac865ce1374`，两个快照字节一致，快照内证据均为 `source=ats` 且路径位于 `data/official-only/jd/`。`data/eval-official-only/freeze.json` 哈希仍为 `5194b7b806d8fb48714ad3b9f91fe1556a737d36750fe41ab7946a4aadcec438`。
