...
- 后端全量：`.venv/bin/pytest -q`，142 passed，1 skipped。已覆盖会话隔离、岗位诊断发布门禁、批量审核幂等、换档模拟、证据级、结构化简历字段、证据地图和推荐岗位。
...
- 快照：新增 `data/snapshot/release-2026-09-02.json`，导出自当前运行图谱，包含 16 个岗位、633 项技能、280 条未撤回证据和 201 个事件；文件 SHA-256 为 `5f0dcd011b0e280f29eaf06dcee0b2c02cde496e1cd0dc0f495f5a1bb771ec55`，内置 evidence hash 与审核快照一致。导出脚本已处理 Neo4j DateTime 属性。`data/eval/freeze.json` 哈希仍为 `5194b7b806d8fb48714ad3b9f91fe1556a737d36750fe41ab7946a4aadcec438`。
